...
class Genre(models.Model):
    ...
    name = models.CharField(
        max_length=32, help_text='Enter a book genre (e.g. Adventure, Science Fiction...)')
...
class Language(models.Model):
    ...
    name = models.CharField(
        max_length=32, help_text="Enter the book's natural language (e.g. English, French...)")
...
class Book(models.Model):
    ...
    summary = models.TextField(
        max_length=1024, help_text='Enter a brief description of the book')
...
class BookInstance(models.Model):
    ...
    imprint = models.CharField(
        max_length=128, help_text='Publisher information')
    ...
    @property
    def is_overdue(self):
        if self.due and date.today() > self.due:
            return True
        return False
